...
extension MediaPlayerVC {
    ...
    func configureMediaPlayerClosure() {
        DispatchQueue.main.async { [weak self] in
            ...
            self?.mediaPlayer.progressEndUpdate = {
                ...
                self?.playButton.setImage(UIImage(named: "Polygon 1.png")?.withRenderingMode(.alwaysOriginal), for: .normal)
    ...
    func configureUIControls() {
        ...
        DispatchQueue.main.async { [weak self] in
            ...
            NSLayoutConstraint.activate([
                ...
                //  ! self.nameTrack.rightAnchor.constraint(equalTo: self.mainView.rightAnchor, constant: 20.0),
            ...
            NSLayoutConstraint.activate([
                ...
                // self.loadViewMessage.widthAnchor.constraint(equalToConstant: 148.0)
            ])
            ...
            NSLayoutConstraint.activate([
                ...
                self!.tabButtonLeft.heightAnchor.constraint(equalToConstant: 24.0),
                self!.tabButtonLeft.widthAnchor.constraint(equalToConstant: 24.0)
            ])
            ...
            NSLayoutConstraint.activate([
                ...
                self!.tabButtonCenter.heightAnchor.constraint(equalToConstant: 26.0),
                self!.tabButtonCenter.widthAnchor.constraint(equalToConstant: 26.0)
            ])
            ...
            NSLayoutConstraint.activate([
                ...
                self!.tabButtonRight.heightAnchor.constraint(equalToConstant: 30.0),
                self!.tabButtonRight.widthAnchor.constraint(equalToConstant: 30.0)
            ])
        }
    ...
    @objc func playButtonPressed() {
        ...
        DispatchQueue.main.async { [weak self] in
            ...
            let currentLink = linksData.networkLinks[0]
            ...
            if let player = self?.mediaPlayer.player {
                ...
                case 2:
                    ...
                    player.play()
                    print("play")
                    self?.playButton.setImage(UIImage(named: "Filled.png")?.withRenderingMode(.alwaysOriginal), for: .normal)
